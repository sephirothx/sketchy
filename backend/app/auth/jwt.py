...
async def get_or_create_jwt_secret(session_factory: async_sessionmaker[AsyncSession]) -> str:
    ...
    async with session_factory() as session:
        ...
        # Generate a new cryptographic 256-bit secret and persist it
...
def set_cached_jwt_secret(secret: str) -> None:
