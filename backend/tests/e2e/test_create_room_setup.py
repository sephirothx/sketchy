...
async def test_create_room_uses_progressive_disclosure_and_validates_custom_words(
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            nickname_dialog = page.get_by_role("dialog", name="Choose a nickname")
            await nickname_dialog.wait_for()
            nickname_input = nickname_dialog.locator('input[placeholder="Your name"]')
            ...
            await nickname_dialog.get_by_role("button", name="Continue").click()
