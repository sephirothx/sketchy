...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Header, an absolute first point, then the -128 escape and a second
        # absolute pair: these two points are a whole canvas apart, far past
        # what a signed-byte delta can carry.
        (
            "draw_move",
