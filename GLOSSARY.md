...
| **Warning** | A moderator's formal notice to a reported player, shown once with the reported messages and **Drawing evidence** behind it and acknowledged by the player. It restricts nothing and sits between dismissing a **Report** and a **Suspension**. | strike, admonition, caution |
