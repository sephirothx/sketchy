...
| **Prompt language** | The BCP-47 content language a room is **declared** to be in, chosen by its host at creation and fixed for the room's life. It selects the game's answer-matching rules — for the room's own **Custom prompts** and for lists in **Any language** as much as for list content — and every selected **Prompt list** must be in it or in **Any language**. It is distinct from the interface locale used for translated catalogue copy. | locale, UI language, list language, room language |
