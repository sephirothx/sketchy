...
| **Runtime observation** | One thing the server recorded about its own behaviour - a join, a disconnect, a timer overrun, a stored drawing's size. Kept in raw form for a bounded window and in daily totals for ever. | metric, log line, telemetry |
