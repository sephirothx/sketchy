...
| **Scratch pad** | The game's canvas and drawing toolbar, for the player alone, offered while the connection is down: on the card over a paused room, and from *Draw while you wait* on the connection banner outside one. Nothing drawn on it is sent or stored; it lasts as long as the tab and can be saved as a picture. Not the game's canvas, and not a **Doodle**, which is an avatar. | doodle pad, sketchbook, offline game, practice canvas |
