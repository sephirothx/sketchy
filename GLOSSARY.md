...
| **Lobby** | The browsable list of public rooms, with the lobby chat and the list of who is online beside it, and a row of links at its foot to the **Gallery** (once there is a session), the **Community catalogue**, **Prompt stats** and the **Rules**. **The lobby is one place, and it is not inside a room.** | browser, room list, home |
