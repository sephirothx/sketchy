...
| **Two-factor authentication** | An authenticator app's six-digit code, required in addition to the password. Optional for a player, required for a moderator or administrator. Always spelled out on first use in player-facing copy; **2FA** is acceptable afterwards. | MFA, OTP, second password, verification code |
