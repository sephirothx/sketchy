...
| **Two-factor authentication** | An authenticator app's six-digit code, required in addition to the password. A staff control: required for a moderator or administrator, and not offered to anybody else. Always spelled out on first use in player-facing copy; **2FA** is acceptable afterwards. | MFA, OTP, second password, verification code |
