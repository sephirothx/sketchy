...
| **Friend mark** | The small two-person silhouette on the bottom-right of a player's avatar, meaning *this person is your friend*. One of three things the disc carries about who is reading it: a ring means **you**, a gold crown means the room's host, and this means a friend. Per-viewer, so two people looking at the same roster see different marks — it describes a relationship rather than a fact about the game. Shown in the lobby's online list, on a profile, and on the seats in a room, where the server resolves it and answers with seats so no account id enters a room payload. | friend badge, friend icon, buddy indicator |
