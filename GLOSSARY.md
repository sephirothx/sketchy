...
| **Room menu** | The one control a room adds to the header: a **Room** button on a wide screen and a ⋯ button on a phone, opening the same rows in the same order — the invite (code, share, copy), AFK, save the drawing, the restart vote, and **Leave the room** last and set apart. The phone's copy also holds **Players and scores** and **Player settings**, which its bar has no room for. | room actions, hamburger, overflow menu, kebab |
