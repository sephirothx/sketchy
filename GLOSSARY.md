...
| **Published list** | A user-owned **Prompt list** whose owner has published it: it appears in the **Community catalogue**, anyone may draw from it in a room, **Star** it, or **Fork** it. Publishing is a deliberate act and can be undone; unpublishing hides the list again without destroying anything. | public list, shared list, released |
...
| **Fork** | A copy of a **Published list** taken into a list of your own, private on creation and yours to edit. It records the exact revision it came from (**Fork provenance**) and counts against your list allowance. | clone, copy, duplicate, remix |
...
| **Fork provenance** | The exact source **Prompt-list revision** a **Fork** was copied from. It is kept for its own sake: both lists go on being edited, and provenance that pointed at a list rather than a revision would stop meaning anything after the first edit. | copied from, parent list, clone |
