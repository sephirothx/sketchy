...
| **Name color** | The one of twelve palette colors a registered player's name and avatar wear everywhere. Chosen from swatches in **Player settings**; the server accepts only a color that reads on both themes' player list. Guests have none: their grey is what marks a name as unclaimed. | name colour (in UI copy), username color, avatar color |
