...
| **Friend mark** | The small two-person silhouette on the bottom-right of a player's avatar, meaning *this person is your friend*. One of three things the disc carries about who is reading it: a ring means **you**, a gold crown means the room's host, and this means a friend. Per-viewer, so two people looking at the same roster see different marks — it describes a relationship rather than a fact about the game. | friend badge, friend icon, buddy indicator |
