...
| **Prompt-list visibility** | Who may resolve a user-owned **Prompt list**: Private means only its owner; Unlisted means its owner or someone with its share code; **Published** means anyone, through the **Community catalogue**. Public is reached by publishing, never by editing. | privacy, public, discoverable |
