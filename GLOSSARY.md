...
| **Scratch pad** | A small canvas only the player sees, offered wherever they wait: in the waiting room, on the card over a paused room, and from *Draw while you wait* on the connection banner outside one. Nothing drawn on it is sent or stored; it lasts as long as the tab and can be saved as a picture. Not the game's canvas, and not a **Doodle**, which is an avatar. | doodle pad, sketchbook, offline game, practice canvas |
