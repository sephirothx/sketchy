...
| **Room menu** | Everything a player can do to the room they are in, other than play: copy the invite link (with the room's code), go away or come back, save the drawing, propose starting over, and **Leave**, always last and in red. **Player settings** are not in it: they are about the player, and the identity chip beside it opens them. One list, dropped down from *Room* in the desktop bar and shown as the ⋯ sheet on a phone, in the same order; a phone adds *Players and scores*, because its players column is folded away. | room actions, overflow menu, kebab menu, ⋯ menu (in UI copy) |
