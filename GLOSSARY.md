...
| **Prompt language** | The BCP-47 content language a room is **declared** to be in, chosen by its host at creation and fixed for the room's life. It selects the game's answer-matching rules — for the room's own **Custom prompts** as much as for list content — and every selected **Prompt list** must be in it. It is distinct from the interface locale used for translated catalogue copy. | locale, UI language, list language, room language |
...
| **Community catalogue** | The browsable list of **Published lists**, separate from the official catalogue of bundled content. Filtered by language and **Prompt tag**, sorted by stars or by recency. | list browser, public lists, store, marketplace |
