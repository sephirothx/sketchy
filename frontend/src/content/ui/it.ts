...
export const IT: Catalogue = {
  ...
  friendsOverlay: {
    ...
    createAnAccountOrSignIn: "Crea un account o accedi per aggiungere amici.",
    loading: "Caricamento…",
  ...
  profilePage: {
    ...
    statisticsAppearAfterFirstGame: "Le statistiche compaiono dopo la prima partita conclusa.",
