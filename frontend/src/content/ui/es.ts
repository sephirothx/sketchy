...
const REFUSALS: Record<ErrorCode, Sentence> = {
  ...
  mixed_room_list_unsupported: "Las salas multilingües solo pueden usar listas en todos los idiomas o en cualquier idioma.",
  mixed_room_custom_prompts: "Las salas multilingües no pueden usar palabras propias: cada jugador necesita la palabra en su idioma.",
  ...
  server_busy: "Sketchy está saturado ahora mismo. Inténtalo de nuevo en un momento.",
  ...
  kicked_from_room: "Te han expulsado de esta sala y no puedes volver.",
  ...
  name_in_use: "Alguien conectado ya juega con ese nombre. Elige otro.",
...
export const ES: Catalogue = {
  ...
  accountRecoveryPage: {
    ...
    yourPasswordIsSetSuspended: "Tu contraseña está establecida, pero esta cuenta está suspendida y no puede iniciar sesión.",
  ...
  app: {
    ...
    dismiss: "Descartar",
    couldNotOpenThis: "No se ha podido abrir. Comprueba tu conexión e inténtalo de nuevo.",
    tryAgain: "Reintentar",
  },
  ...
  firstRunIdentity: {
    ...
    lines: [
      "¿Eso es un submarino? Yo pensaba que era un cepillo de dientes.",
      "Es hora de demostrar que tu profe de dibujo se equivocaba.",
      "Cubismo, pero sin querer.",
      "¿Eres tú, Miguel Ángel?",
      "¡Vaya, parece un Pollock!",
    ],
  },
  ...
  communityCataloguePage: {
    playThisList: "Jugar con esta lista",
    backToLobby: "Volver al vestíbulo",
    loading: "Cargando…",
    ...
    copyCount: (p: { count: number }) =>
      counted(p.count, { one: "copia", other: "copias" }),
    ...
    chooseAListBody: "Sus etiquetas y todas sus palabras.",
    promptsHeading: "Palabras",
    inTheAuthorsOrder: "En el orden original",
    shownOfTotal: (p: { shown: number; total: number }) => `Se muestran ${number(p.shown)} de ${number(p.total)}`,
    exploreAll: (p: { count: number }) => `Ver las ${counted(p.count, { one: "palabra", other: "palabras" })}`,
    allPrompts: (p: { count: number }) => `Las ${counted(p.count, { one: "palabra", other: "palabras" })}`,
  ...
  galleryPage: {
    ...
    pause: "Pausa",
    play: "Reproducir",
    replayPosition: "Punto de la reproducción",
  ...
  profilePage: {
    ...
    unpin: "Quitar",
    couldNotUpdatePinnedDrawings: "No se pudieron actualizar tus dibujos fijados. Inténtalo de nuevo.",
    couldNotLoadThisDrawing: "No se pudo cargar este dibujo.",
  ...
  promptListPicker: {
    ...
    starredNotAllShown: (p: { shown: number }) => `Se muestran las primeras ${number(p.shown)} listas que marcaste con estrella.`,
  ...
  publicRoomCard: {
    ...
    columnRoomRules: "Reglas de la sala",
  },
  ...
  settingsOverlay: {
    ...
    defaultBrushSize: "Tamaño de pincel predeterminado",
