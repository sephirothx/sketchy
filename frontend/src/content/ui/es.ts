...
export const ES: Catalogue = {
  ...
  friendsOverlay: {
    ...
    createAnAccountOrSignIn: "Crea una cuenta o inicia sesión para añadir amigos.",
    loading: "Cargando…",
  ...
  profilePage: {
    ...
    statisticsAppearAfterFirstGame: "Las estadísticas aparecen tras la primera partida terminada.",
    notKept: "no guardado",
