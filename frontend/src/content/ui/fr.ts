...
export const FR: Catalogue = {
  ...
  friendsOverlay: {
    ...
    createAnAccountOrSignIn: "Crée un compte ou connecte-toi pour ajouter des amis.",
    loading: "Chargement…",
  ...
  profilePage: {
    ...
    statisticsAppearAfterFirstGame: "Les statistiques apparaissent après la première partie terminée.",
