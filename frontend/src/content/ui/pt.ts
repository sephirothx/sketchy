...
export const PT: Catalogue = {
  ...
  friendsOverlay: {
    ...
    createAnAccountOrSignIn: "Cria uma conta ou inicia sessão para adicionares amigos.",
    loading: "A carregar…",
  ...
  profilePage: {
    ...
    statisticsAppearAfterFirstGame: "As estatísticas aparecem depois do primeiro jogo terminado.",
