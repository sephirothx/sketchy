...
const REFUSALS: Record<ErrorCode, Sentence> = {
  ...
  seat_changing_too_fast: "Dein Platz in diesem Raum ist zu oft zwischen Tabs oder Verbindungen gewechselt. Versuch es in einer Minute noch einmal.",
  ...
  server_busy: "Sketchy ist gerade ausgelastet. Versuche es gleich noch einmal.",
  ...
  kicked_from_room: "Du wurdest aus diesem Raum geworfen und kannst nicht zurückkommen.",
  ...
  name_in_use: "Jemand, der gerade online ist, spielt schon unter diesem Namen. Wähle einen anderen.",
...
export const DE: Catalogue = {
  ...
  accountMenu: {
    ...
    guestNameNotSaved: "Gastname, nicht in einem Konto gespeichert",
  ...
  app: {
    ...
    dismiss: "Ausblenden",
    couldNotOpenThis: "Das ließ sich nicht öffnen. Prüf deine Verbindung und versuch es noch einmal.",
  ...
  dialog: {
    close: "Schließen",
    cancel: "Abbrechen",
    couldNotSave: "Konnte nicht gespeichert werden. Versuch es noch einmal.",
  },
  ...
  lobbyBrowserPage: {
    ...
    noPublicRoomsYet: "Noch keine öffentlichen Räume",
    noPublicRoomsYetBody: "Schnell spielen öffnet einen für dich, oder erstelle deinen eigenen.",
  ...
  communityCataloguePage: {
    ...
    listsPlayersPublished: "Listen, die Spielerinnen und Spieler veröffentlicht haben.",
    couldNotLoadTheCatalogue: "Der Community-Katalog konnte nicht geladen werden.",
    couldNotOpenThatList: "Diese Liste konnte nicht geöffnet werden.",
    language: "Sprache",
    sortBy: "Sortieren nach",
    mostStarred: "Meiste Sterne",
    newest: "Neueste",
    onlyOnesIStarred: "Nur mit meinem Stern",
    clearFilters: "Filter zurücksetzen",
    ...
    whatIsInIt: "Inhalt",
    couldNotChangeTheStar: "Der Stern konnte nicht geändert werden.",
    copiedToYourLists: "In die eigenen Begriffslisten kopiert.",
    couldNotCopyThatList: "Diese Liste konnte nicht kopiert werden.",
    ...
    starButton: (p: { count: number; starred: boolean }) =>
      p.starred ? `Stern entfernen (${counted(p.count, { one: "Stern", other: "Sterne" })})` : `Mit Stern markieren (${counted(p.count, { one: "Stern", other: "Sterne" })})`,
    chooseAList: "Eine Liste wählen, um zu sehen, was darin steckt",
    chooseAListBody: "Ihre Schlagwörter und alle Begriffe darin.",
    promptsHeading: "Begriffe",
    inTheAuthorsOrder: "In der Originalreihenfolge",
    shownOfTotal: (p: { shown: number; total: number }) => `${number(p.shown)} von ${number(p.total)} angezeigt`,
    exploreAll: (p: { count: number }) => `Alle ${counted(p.count, { one: "Begriff", other: "Begriffe" })} ansehen`,
    allPrompts: (p: { count: number }) => `Alle ${counted(p.count, { one: "Begriff", other: "Begriffe" })}`,
    searchPrompts: "Begriffe durchsuchen",
    matchesOfTotal: (p: { matches: number; total: number }) => `${number(p.matches)} von ${number(p.total)}`,
    order: "Reihenfolge",
    authorsOrder: "Original",
    alphabetical: "A–Z",
    noPromptMatches: (p: { query: string }) => `Kein Begriff enthält „${p.query}“.`,
  ...
  galleryPage: {
    ...
    nothingThisWeek: "Diese Woche noch nichts.",
    nothingHereYet: "Noch keine Zeichnungen",
    signInToSeeTheGallery: "Melde dich an, um die Galerie zu sehen",
    couldNotLoadTheGallery: "Die Galerie konnte nicht geladen werden.",
    couldNotLoadThisDrawing: "Diese Zeichnung konnte nicht geladen werden.",
    showMore: "Mehr anzeigen",
    tryAgain: "Noch einmal versuchen",
    ...
    pause: "Pause",
    play: "Abspielen",
    replayPosition: "Stand der Wiedergabe",
  ...
  myPromptListsPage: {
    ...
    myPromptLists: "Meine Begriffslisten",
    newList: "Neue Liste",
    promptListsNeedAnAccount: "Deine Begriffslisten brauchen ein Konto",
    promptListsNeedAnAccountBody: "Ein Konto bewahrt deine Listen auf, für jeden Raum, den du leitest, und zum Veröffentlichen, wenn du magst. Eigene Begriffe, die du in einem Raum eintippst, werden nicht gespeichert.",
    loading: "Wird geladen …",
  ...
  profilePage: {
    ...
    includeAbandonedGames: "Abgebrochene Spiele einbeziehen",
    winsAndScoresAppearAfterFirstGame: "Siege und Punkte erscheinen nach dem ersten beendeten Spiel.",
    notKept: "nicht aufbewahrt",
    pinnedDrawings: "Angeheftete Zeichnungen",
    nothingPinnedYet: "Noch nichts angeheftet. Hefte eine Zeichnung aus dem Rückblick eines Spiels an, oder aus einem Spiel in deinem Verlauf unten.",
    openPinnedDrawing: (p: { prompt: string; drawer: string }) => `${p.prompt} von ${p.drawer} öffnen`,
    moveLeft: "Nach links",
    moveRight: "Nach rechts",
    unpin: "Lösen",
    couldNotUpdatePinnedDrawings: "Deine angehefteten Zeichnungen konnten nicht aktualisiert werden. Bitte versuche es erneut.",
    couldNotLoadThisDrawing: "Diese Zeichnung konnte nicht geladen werden.",
  ...
  promptContentReportDialog: {
    ...
    sentWithTheListAttached: "Gesendet, mit einer Kopie der Liste in ihrer jetzigen Fassung.",
    content: "Inhalt",
  ...
  reportDialog: {
    ...
    couldNotSend: "Die Meldung konnte nicht gesendet werden.",
    charactersLeft: (p: { count: number }) =>
      `Noch ${counted(p.count, { one: "Zeichen", other: "Zeichen" })}`,
  },
  reportDrawingDialog: {
  ...
  sessionManagerDialog: {
    ...
    logOutEverywhereTitle: "Überall abmelden?",
    logOutEverywhereBody: "Jedes Gerät, das mit diesem Konto angemeldet ist, wird abgemeldet, auch dieses. Hier musst du dich danach wieder anmelden.",
  },
  ...
  avatarDoodleDialog: {
    title: "Doodle wählen",
    intro: "In deiner Namensfarbe, überall, wo dein Name erscheint.",
  ...
  toolbar: {
    ...
    sizeShortcutHint: (p: { tool: string; width: number; keys: string }) =>
      `${p.tool}, Größe: ${p.width}px (${p.keys})`,
    ...
    undoWithShortcut: (p: { keys: string }) => `Letzten Strich rückgängig machen (${p.keys})`,
    clear: "Leeren",
    brush: "Pinsel",
    fill: "Füllen",
    eraser: "Radierer",
  ...
  passwordPolicy: {
    ...
    rule: (p: { count: number }) => `Mindestens ${p.count} Zeichen.`,
  },
  operatorAccess: {
