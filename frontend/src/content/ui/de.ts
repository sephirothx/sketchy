...
export const DE: Catalogue = {
  ...
  friendsOverlay: {
    ...
    createAnAccountOrSignIn: "Erstelle ein Konto oder melde dich an, um Freunde hinzuzufügen.",
  ...
  profilePage: {
    ...
    statisticsAppearAfterFirstGame: "Statistiken erscheinen nach dem ersten beendeten Spiel.",
