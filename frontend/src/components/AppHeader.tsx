 ...
 * on a narrow phone it is the only way there. A visitor with no name yet has
 * no chip: the first-run name tag links the Rules (`FirstRunIdentity`), and
 * the other pages come once they have chosen a name.
 *
