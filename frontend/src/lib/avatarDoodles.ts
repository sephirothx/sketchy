 ...
 *
 * Each is a symbol in `public/avatars/doodles.svg`, drawn with currentColor
 * so the disc's ink paints it and the name color keeps meaning. The server
 * holds the same list (`app/auth/avatar_doodles.py`) and a test holds the
 * two and the sprite together. No imports, so it loads anywhere.
 */
