...
[`docs/ui-mockups/mobile/`](docs/ui-mockups/mobile/README.md) reviews those same screens on a
portrait phone and proposes layouts for them; unlike the artboards, it is a proposal rather
than a record of what ships.
