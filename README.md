...
them. `--tolerance` is the number that decides the result: how far a sample's width may
be from the ramp drawn in its place. A repeated identical batch, which is what the benchmark
