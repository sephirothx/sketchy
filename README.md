...
- The header is the same on every page: it spans the widest column the window allows,
  ...
  Rules, while each page keeps the width its own content reads best at. The browser tab
  names the page you are on - "Gallery · Sketchy", or the room's own name in a room.
