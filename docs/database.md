...
any list its owner has ever held, in the same language or in no language (`zxx`, which shares its words with every language, #821), keyed under this list's fold (#1091) — a word typed back in, into
