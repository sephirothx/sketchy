...
| --- | --- | --- |
| `PROTOCOL_VERSION` (40) | The socket handshake: which commands, events and payload keys both ends agree on (§1) | A command or event is added, removed or renamed, or a payload's shape changes. Both ends deploy together |
