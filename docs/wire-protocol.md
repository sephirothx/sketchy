...
a conditional request is answered against the bytes the client would receive; a 304
answered against the original file itself still carries `Vary: Accept-Encoding`. Nothing
