...
method kept, and any byte of the path or query outside printable ASCII escaped as `%XX` (#1015) — unless it is one of the three probe paths. A response the application gave
