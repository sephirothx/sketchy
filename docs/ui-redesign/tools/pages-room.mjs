...
const tile = (ch, revealed) => revealed
  ? `<span style="display: inline-flex; align-items: center; justify-content: center; width: 26px; height: 34px; padding-bottom: 0.22em; box-sizing: border-box; border-radius: 7px; background: ${T.primarySoft}; border: 1.5px solid ${T.primary}; font-family: ${T.display}; font-weight: 600; font-size: 18px; color: ${T.primaryInk}">${ch}</span>`
