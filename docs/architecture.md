...
| [`app/services/friend_presence.py`](../backend/app/services/friend_presence.py) | Which of an account's friends are online, told to that account alone on the presence tick — uncapped, and without the lobby channel. |
